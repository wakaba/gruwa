  ...
  <section class=help>
    ...
    <section id=import>
      ...
      <section id=import-hatenagroup>
        ...
        <p>キーワードリンクのリンク先をインポートしたキーワードページにするためには、
        インポートによって作成された <a href=#wikis>Wiki</a> 
        を<a href=#default-wiki-index>グループの Wiki</a> に設定してください。
        なお、記事中のキーワードの自動リンクには対応していません。
